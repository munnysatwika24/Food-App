...
import 'foodCourtList/my_list.dart';
void main() {
  runApp(MaterialApp(debugShowCheckedModeBanner: false,home: RepositoryProvider(create: (context)=>FoodCourtRepository(),child:MyFoodCourtList() ,),));
}
